...
namespace IShow.ChooseDishes
{
    ...
    public interface IDishesWayDataService
    {
        ...
        bool Add(string _Code, int _DishesWayNameId, string _Name, string _PingYing, double _AddPrice, int _AddPriceByNum);
        /**根据做法对象作为参数修改做法*/
        [OperationContract]
        ...
        /**根据做法编码查找做法*/
        [OperationContract]
        List<DischesWay> FindDishesWayByCode(string code);
